...
public class ApplyingRule4 {
    ...
    public void verifyingFirstName() {
        ...
        public void verifyingMobileNumber() {
        ...
        public void applyingRuleFourth() {
            System.out.println("Enter value for fourth rule: ");
            String third = scanner.next();
            Pattern pattern = Pattern.compile("^[a-zA-Z0-9]{1,}[a-zA-Z0-9]{7,}[~!@#$%^&*]{1}$");
            Matcher match = pattern.matcher(third);
        ...
        public static void main (String[]args){
            ApplyingRule4 rule = new ApplyingRule4();
            rule.applyingRuleFourth();
        }
    }
